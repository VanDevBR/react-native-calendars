  ...
  onVisibleMonthsChange(months) {
    ...
    if (this.props.items && !this.state.firstResevationLoad) {
      ...
      this.scrollTimeout = setTimeout(() => {
        if (this.props.loadItemsForMonth && this._isMounted && !this.props.disableExtraDays) {
  ...
  renderTodayButton() {
    ...
    return (
      <Animated.View style={[this.styles.todayButtonContainer, {transform: [{translateY: buttonY}]}]}>
        <TouchableOpacity style={[this.styles.todayButton, this.props.todayButtonStyle]} onPress={this.goToday} disabled={disabled}>
